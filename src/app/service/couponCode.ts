...
var badWordsList= ('SHPX PHAG JNAX JNAT CVFF PBPX FUVG GJNG GVGF SNEG URYY ZHSS QVPX XABO ' +
    ...
    .replace(/[a-zA-Z]/g, function (c:any) { return String.fromCharCode((c <= "Z" ? 90 : 122) >= (c = c.charCodeAt(0) + 13) ? c : c - 26); })
    .split(' ');
var symbolsStr = '0123456789ABCDEFGHJKLMNPQRTUVWXY';
var symbolsArr:any = symbolsStr.split('');
var symbolsObj = {};
...
export { hasBadWord, validate, generate };
